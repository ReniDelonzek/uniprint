...
class MaterialProf {
  ...
  static MaterialProf fromMap(Map<String, dynamic> map) {
    ...
    return MaterialProf(
      data_publicacao: DateTime.fromMillisecondsSinceEpoch(map['data_publicacao']),
      tipo: map['tipo'],
      titulo: map['titulo'],
      ...
      arquivos: List<ArquivoMaterial>.from(map['arquivos']?.map((x) => ArquivoMaterial.fromMap(x))),
    );
  }
